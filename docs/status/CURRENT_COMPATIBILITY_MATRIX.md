...
Published: **0.7.9 experimental prerelease**. Primary target: BeamNG 0.39.4.
...
| Events/Race | removed-slot tombstones, independent origin/heading, rigid-group fallback, bounded reposition progress and read-only Preview rendering | Pending owner validation |
| AI/Playground | command parity, physical/placement/drivability eligibility, partial startup evidence and contact/Tag foundations | Pending owner validation |
...
| Package | downloaded ZIP/checksum/manifest verified; forbidden-content and extracted graph gates passed | Not applicable (publication evidence) |
