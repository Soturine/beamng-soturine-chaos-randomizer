...
Current source: 0.6.3 release candidate on `fix/v0.6.3-live-lifecycle`.
...
Live BeamNG status: **not executed**. The reproducible candidate is
...
The candidate must not be tagged or released until this exact ZIP passes the
mandatory live gate.
