...
- At least one clean BeamNG 0.39 profile.
- The exact attached `soturine_chaos_randomizer_0.7.0.zip`, verified against its attached `.sha256` on both machines.
