...
class PackageTests(unittest.TestCase):
    ...
    def test_release_manifest_matches_zip(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(manifest["tests"]["javaScriptChecks"], 779)
            self.assertEqual(manifest["tests"]["vueModuleGraphFiles"], 78)
            self.assertEqual(manifest["tests"]["vueModuleGraphReachableFiles"], 74)
            self.assertEqual(manifest["tests"]["vueModuleGraphImports"], 193)
            self.assertEqual(manifest["tests"]["vueModuleGraphProjectImports"], 154)
