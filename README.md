...
- **Seed mode** lives in Settings. Random every run is the default; Fixed manual seed makes project-owned choices repeatable when the game version, content, settings, and starting state are unchanged.
